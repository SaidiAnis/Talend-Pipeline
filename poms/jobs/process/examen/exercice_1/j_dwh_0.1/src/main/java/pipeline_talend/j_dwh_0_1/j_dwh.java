...
package pipeline_talend.j_dwh_0_1;
 ...
 * @status
 */
public class j_dwh implements TalendJob {
	...
	private final String jobName = "j_dwh";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(j_dwh.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
		final static byte[] commonByteArrayLock_PIPELINE_TALEND_j_dwh = new byte[0];
		static byte[] commonByteArray_PIPELINE_TALEND_j_dwh = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PIPELINE_TALEND_j_dwh.length) {
					if (length < 1024 && commonByteArray_PIPELINE_TALEND_j_dwh.length == 0) {
						commonByteArray_PIPELINE_TALEND_j_dwh = new byte[1024];
					} else {
						commonByteArray_PIPELINE_TALEND_j_dwh = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PIPELINE_TALEND_j_dwh, 0, length);
				strReturn = new String(commonByteArray_PIPELINE_TALEND_j_dwh, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_PIPELINE_TALEND_j_dwh, 0, length);
				strReturn = new String(commonByteArray_PIPELINE_TALEND_j_dwh, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PIPELINE_TALEND_j_dwh) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:Ds9RJ/xUQUksKYBr9dBm89FOy/0n0MlKAhhoBAvypgVn0He9");
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:uRvGDRDeGlrT1ZulEFEOLlx4D0v9U681u0rdCvRLiKxds5fN");
				...
				final String decryptedPassword_tDBOutput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:a0BnHMDoy5BPxo1UgAHDJRRf87L8QRgiwXJ3a7CpaIvqh/gw");
				...
				final String decryptedPassword_tDBOutput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:0eVr8EWW7fsAp0jq3zdj7vsSlKzu5l98qDZjIZ+GaItP9Za0");
...
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:nd596G5heLn7qSbsfbXY5TSKLKMPim9OUPQKdQ==");
				...
				Object source_tFileInputExcel_1 = "C:/Data/exo1/Hypermarche.xlsx";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_2 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:CEI1cREGyVoVJzn6byYatvTdZ34xAt9QQmUHyw==");
				...
				Object source_tFileInputExcel_2 = "C:/Data/exo1/Objectifs_ventes.xlsx";
...
// Start of branch "row2"
	...
	public static void main(String[] args) {
		final j_dwh j_dwhClass = new j_dwh();

		int exitCode = j_dwhClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = j_dwh.class.getClassLoader()
					.getResourceAsStream("pipeline_talend/j_dwh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = j_dwh.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : j_dwh");
		}
...
/************************************************************************************************
 * 296446 characters generated by Talend Open Studio for Data Integration on the
 * 23 mars 2025, 12:58:59 CET
 ************************************************************************************************/